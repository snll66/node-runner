...
const 上传秘址 = process.env.UPLOAD_URL || '';      // 自动上传地址
...
const 订阅暗号 = process.env.SUB_PATH || 'admin';       // dingyue路径
...
const 星门域名 = process.env.ARGO_DOMAIN || 'dcdeploy.mavita.kdns.fr';          // 固定星门域名,留空启用临时通道
const 星门密钥 = process.env.ARGO_AUTH || 'eyJhIjoiNDBiOTVkNGE4NDI3MTM0YjE5YzViOTgzOGIyNjU5YWIiLCJ0IjoiYWI0NzJjMDAtNDAyYS00MTY2LThlYzAtYTYyMzc0MWUyMjUzIiwicyI6IlpUTmxObVE0WTJVdE9UZGlOUzAwTlRWaUxXSmpaak10T0RJMlpXRTBPV0UwTldNMSJ9';              // 固定星门密钥,留空启用临时通道
